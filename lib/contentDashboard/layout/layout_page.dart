...
import 'package:projector/contentDashboard/layout/slideshow_settings.dart';
import 'package:projector/widgets/widgets.dart';
import 'package:provider/provider.dart';

import 'layout_category_screen.dart';
import 'layout_photo_album_screen.dart';
import 'layout_playlist_screen.dart';
import 'layout_sub_category_screen.dart';
...
class _LayoutPageState extends State<LayoutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ChangeNotifierProvider<LayoutProvider>(
          create: ((context) => LayoutProvider()..initialize()),
          child: Container(
            child: ListView(
              children: [
                SizedBox(
                                ...
                                return Container(
                                  ...
                                  child: ReorderableListView(
                                      ...
                                      children: List.generate(
                                        ...
                                        var contentType = snapshot.data[index]
                                            ['content_type'];
                                        var orderNumber = snapshot.data[index]
                                            ['order_number'];
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              boxShadow: [
                                                BoxShadow(
                                                  ...
                                                  spreadRadius: 1.5,
                                                  offset: Offset(0.0,
                                                      0.0), // shadow direction: 360 degree
                                                )
                                              ],
                                            ),
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    ...
                                                    if (id == "1") {
                                                      navigate(context,
                                                          LayoutCategoryScreen());
                                                    }
                                                    if (id == "2") {
                                                      navigate(context,
                                                          LayoutPlaylistScreen());
                                                    }
                                                    if (id == "3") {
                                                      navigate(context,
                                                          LayoutPhotoAlbumScreen());
                                                    }
                                                  },
                                                  child: Container(
                                                    margin: EdgeInsets.only(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                ...
                                spreadRadius: 1.5,
                                offset: Offset(
                                    0.0, 0.0), // shadow direction: 360 degree
                              )
                            ],
                          ),
                          child: Row(
