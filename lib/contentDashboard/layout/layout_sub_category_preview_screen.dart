...
class LayoutSubCategoryPreviewScreen extends StatefulWidget {
  LayoutSubCategoryPreviewScreen({this.title, @required this.subCategoryId});
  final String title, subCategoryId;

  @override
  _LayoutSubCategoryPreviewScreenState createState() =>
      _LayoutSubCategoryPreviewScreenState();
}

class _LayoutSubCategoryPreviewScreenState
    extends State<LayoutSubCategoryPreviewScreen> {
